        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 flex items-center md:mb-0">
              <a href="https://yelindo.id/" className="flex items-center">
                  <img src="https://media.discordapp.net/attachments/763335756403703839/1096388080556064778/logo_yel_baru.png?width=494&height=468" class=" h-16 mr-3" alt="Yelindo Logo" />
                  <span class="self-center text-3xl font-bold whitespace-nowrap dark:text-white">PT. YELINDO <br></br> SURYA JAYA </span>
              </a>
          </div>
