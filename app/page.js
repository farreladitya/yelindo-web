...
<span class="text-white ml-1">Hubungi Kami</span>
      </a>
    </div>
    </div>
  </div>
...
<div class="bg-white max-w-md rounded-md overflow-hidden shadow-lg hover:scale-105 transition duration-500 cursor-pointer flex flex-col justify-center items-center">
  ...
  <div class="flex flex-col md:items-center md:justify-center">
    <span class="text-3xl md:self-start md:mt-1 md:text-5xl font-bold">PT. YELINDO SURYA JAYA</span> 
    <h3 class="text-gray-600 max-[637px]:hidden md:self-center text-justify md:text-xl">Perusahaan yang bergerak di bidang perdagangan alat kesehatan tercatat pada akte pendirian perseroan terbatas pada tanggal 26 November 2020 dengan alamat Jl.Jambangan Kebon Agung Nomor 11 Surabaya, dengan personil perusahaan yang cukup berpengalaman lebih dari 20 tahun dibidangnya. Mempunyai visi misi sebagai berikut :</h3>
  </div>
</div>
</div>
      <div className='text-gray-600  font-normal text-lg px-14 text-justify min-[637px]:hidden'>
          Perusahaan yang bergerak di bidang perdagangan alat kesehatan tercatat pada akte pendirian perseroan terbatas pada tanggal 26 November 2020 dengan alamat Jl.Jambangan Kebon Agung Nomor 11 Surabaya, dengan personil perusahaan yang cukup berpengalaman lebih dari 20 tahun dibidangnya. Mempunyai visi misi sebagai berikut :
      </div>
      <div class="flex flex-wrap items-center justify-center md:items-start ">
  <div class="text-left md:w-1/2 flex flex-col justify-center items-center">
    <img src="https://cdn.discordapp.com/attachments/763335756403703839/1096473263858782398/VISI.png" class="py-6 mt-0 " alt="Visi" />
    <div class="text-gray-600 font-semibold text-lg px-14">
      MENJADI DISTRIBUTOR YANG HANDAL, TERPERCAYA, TERBAIK DAN TERDEPAN DALAM MELAYANI DAN MENDISTRIBUSIKAN KEBUTUHAN ALAT KESEHATAN DI MASYARAKAT DENGAN FOKUS PADA PELAYANAN DAN KEPUASAN PELANGGAN
    </div>
  </div>
  <div class="text-left md:w-1/2 flex flex-col justify-center items-center">
    <img src="https://media.discordapp.net/attachments/763335756403703839/1096473263196086292/MISI.png" class="py-6 " alt="Misi" />
    <div class="text-gray-600 font-semibold text-lg px-14">
      <ul class="list-disc">
        <li class="list-item">MENYEDIAKAN SEGALA KEBUTUHAN ALAT KESEHATAN YANG BERKUALITAS SERTA MENDISTRIBUSIKANNYA SECARA CEPAT DAN EFISIEN KE SELURUH DAERAH</li>
        <li class="list-item">KOMPETITIF DAN BERDAYA SAING TINGGI</li>
        <li class="list-item">LAYANAN PRIMA YANG MENGUTAMAKAN KEPUASAN PELANGGAN</li>
      </ul>
    </div>
  </div>
</div>
